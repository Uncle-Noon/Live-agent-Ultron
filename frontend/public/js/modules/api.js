...
export const chatVisionStream = (message, email, imageData, signal) => fetch(`${API_BASE}/chat-vision-stream`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ message, email, imageData }), signal });
